...
public class Mail {
	...
	public boolean addFileAffix(String filename) {
		...
		try {
			...
			FileDataSource fileds = new FileDataSource(f.getAbsoluteFile());
	...
	public static void main(String[] args) {
		...
		String from = "zhinanzhou@126.com";
		String to = "zhouguogong@qq.com";
		String copyto = "330944287@qq.com";
		String subject = "邮件主题";
		String content = "邮件内容";
		...
		System.out.print(args.length == 4);
